...
/**
 * Description of HitungKeterlambatanController
 *
 * @author miyzan
 */
...
class HitungKeterlambatanController extends Controller{
    //put your code here
    public function index(Request $request){
        ...
        $table=MYModel::getDBTable('v_absen_terlambat');
//        if($tglawal){
//            if($tglakhir){
//                
//            }
...
//            $table->where(array(['nik', 'LIKE', '%'.$query.'%']));
    ...
    public function executeRow(Request $request){
        ...
        $data=MYModel::SP_execData('sp_calc_terlambat',array($thbl),true);
