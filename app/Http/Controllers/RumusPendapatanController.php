...
use App\Models\RumusPendapatan;

class RumusPendapatanController extends Controller {

    public function index(Request $request) {
        $data=RumusPendapatan::all();
...
//vcolumn_name
        ...
        if (count($postdata)>0){
            ...
            $data=RumusPendapatan::SP_execData('sp_rumuspendapatan',$param,true);
