Ext.define('Penggajian.view.rumus.pendapatan.RmsPendapatanController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.rmspendapatan',
    ...
    getDataSet:function(){
        ...
        Ext.Ajax.request({
            ...
            success: function(obj, opts) {
                ...
                var data=resp.data;  
                //                console.log(data);
                var gridView = Ext.getCmp('rmspendapatan_grid');
                var me=Ext.getCmp('tab1g1').controller;
    ...
    genStore : function (json) {
        ...
        var gridstore=app.getStore('storerumuspendapatan');
            ...
            if(field=='col0'){
                col={
                    ...
                    editor:{
                        ...
                        xtype:'combo',
                        id:'rumuspendapatan_'+field,
                        name:'rumuspendapatan_'+field,
                        hiddenName:'rumuspendapatan_'+field,                                                                                        
                        ...
                        listeners:{
                            ...
                            //                                 var gvStore=Ext.getCmp('rmspendapatan_grid').store;
                            ...
                            select:function( combo, records, eOpts ){
                                ...
                                if(frec){
                                    combo.setValue(null);
                                    set_message(2,'Record Is Exists On Entry Grid, Try Another Data !!! ');
                                    Ext.getCmp('rmspendapatan_grid').getView().refresh();
                                }
                ...
                col={
                    ...
                    editor:{
                        xtype:'twincombo',
                        id:'rumuspendapatan_'+field,                    
                        menu:'pendapataneditor',                    
                        width: 95,
                        name: 'rumuspendapatan_'+field,
                        itemId: 'itemIdrumuspendapatan_'+field  ,
                        listeners:{
                            onChange:function(){}
                        }
...
//         return;
        execute_confirm('Are you sure to save this ?', Penggajian.Global.getApiUrl()+'rumuspendapatan/save', {
