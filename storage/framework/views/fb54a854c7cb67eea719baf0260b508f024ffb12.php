...
<html manifest="">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo asset('public/style/mainstyle.css'); ?>"> 
        ...
        -->
        <script type="text/javascript" src="<?php echo asset('public/js/md5.js'); ?>"></script>
        <script type="text/javascript">
            ...
            function to_print(domid,url){      
                Ext.getDom(domid).src ="<?php echo e(url('/').'/'); ?>" + url;
            }
...
//                                        var vdiv=divEl.textContent;
        ...
        <script type="text/javascript" language="javascript">
            function getusersession(){
                return "<?php echo e($data['success']); ?>";
            }
            
            function gettokendata(){
                return "<?php echo e(csrf_token()); ?>";
            }
            var userstatus="<?php echo e($data['success']); ?>";
        
            var tokendata="<?php echo e(csrf_token()); ?>";
            var dataoperator=[['+','+'],['-','-'],['*','x'],['/','/'],['(','('],[')',')']];
